...
num_simulations <- 5000  # Number of datasets to generate per true mean
...
for (mu in true_mus) {
  for (i in 1:num_simulations) {
    ...
    # Conduct the one-sample t-test against mu = 0
...
# Calculate average estimate of mu_hat for all samples and those where H0 was rejected
...
# Interpretations
Power increases with the effect size (true mean), as shown in the power curve plot.
The average estimate of mu is close to the true mu in both the full sample and the subset where H0 is rejected. However, for larger true means, there's a slight upward bias in the 'Rejected H0 Only' subset due to selective reporting.
